...
# إعداد كود جمناي الخاص بكimport os # تأكد من وجود هذا السطر فوق

# سحب المفتاح من إعدادات Railway تلقائياً
GEMINI_API_KEY = os.getenv("GEMINI_KEY")

if GEMINI_API_KEY:
    genai.configure(api_key=GEMINI_API_KEY)
    # استخدام هذا السطر لحل مشكلة 404
    model = genai.GenerativeModel('gemini-1.5-flash')
else:
    print("⚠️ لم يتم العثور على مفتاح Gemini في المتغيرات!")
